...
public class ServeurPrincipal {
    ...
    /**
     *
     * @param nf : chemin d'accès du fichier que l'on veut transformer en JsonObject
     *           Les données dans le fichier à l'adresse nf doit être en format Json
     *           Exple : {"a":"b","c":5} OK
     *                  {"a":"b"}{"c":5} OK mais ne prend en compte que le premier {}.
     * @return  JsonObject créer à base des données dans le fichier à l'adresse nf.
     *          null si le fichier est inaccessible ou que les données dans le fichier ne respectent pas le format JSON
     */

    public static JsonObject creerJsonAvecFile(String nf){
        try {
            ...
            System.out.println("Le fichier : "+nf+" n'a pas été trouvé.\n Veillez vérifier que le fichier "+nf+ " se trouve bien dans le même emplacement que le ServeurPrincipal.jar.\n Redémarer le programme. ");
            return null;
        }
    }
